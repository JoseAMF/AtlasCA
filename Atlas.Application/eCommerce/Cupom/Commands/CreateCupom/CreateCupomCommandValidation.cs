...
namespace Atlas.Application.eCommerce.Cupom.Commands.CreateCupom
{
    public class CreateCupomCommandValidation : AbstractValidator<CreateCupomCommand>
    {
        ...
        private IeCommerceDbContextService Contextservice { get; }

        private string ErrorMessage = "Error";

        public CreateCupomCommandValidation(IeCommerceDbContextService contextservice, IRuleEngineService ruleEngineService)
        {
        ...
        {
            var context = Contextservice.GetContextInitials(cupom.Ambiente);
