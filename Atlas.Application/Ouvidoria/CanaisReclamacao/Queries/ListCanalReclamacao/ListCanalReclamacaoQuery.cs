...
{
    public class ListCanalReclamacaoQuery : IRequest<List<CanalReclamacaoDTO>>
    {
    }


    public class ListCanalReclamacaoHandler : IRequestHandler<ListCanalReclamacaoQuery, List<CanalReclamacaoDTO>>
    {
        ...
        public async Task<List<CanalReclamacaoDTO>> Handle(ListCanalReclamacaoQuery request, CancellationToken cancellationToken)
        {
