...
{
    public class ListAssuntoQuery  : IRequest<List<AssuntoDTO>>
    {
    }


    public class ListAssuntoHandler : IRequestHandler<ListAssuntoQuery, List<AssuntoDTO>>
    {
        ...
        public async Task<List<AssuntoDTO>> Handle(ListAssuntoQuery request, CancellationToken cancellationToken)
        {
