...
namespace Atlas.Domain.Entities.eCommerce
{
    ...
    {
        public TbPropostaSegurado()
        {
            TbPropostaBeneficiario = new HashSet<TbPropostaBeneficiario>();
            TbPropostaDeclaracaoSaude = new HashSet<TbPropostaDeclaracaoSaude>();
        }
        ...
        public virtual ICollection<TbPropostaBeneficiario> TbPropostaBeneficiario { get; set; }
        public virtual ICollection<TbPropostaDeclaracaoSaude> TbPropostaDeclaracaoSaude { get; set; }
    }
}
